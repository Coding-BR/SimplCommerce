(function ($) {
    ...
    /*---stickey menu---*/
    /* Commented out as requested by user - header should scroll with content
    ...
    */
    ...
    /* Commented out to avoid conflict with Blazor/site.js
    $('.canvas_open > a').on('click', function () {
        $('.offcanvas_menu_wrapper,.body_overlay').addClass('active');
    });
    $('.canvas_close a,.body_overlay').on('click', function () {
    ...
    */
    ...
    $(document).ready(function () {
        // Comentado para permitir que Blazor gerencie os selects corretamente
